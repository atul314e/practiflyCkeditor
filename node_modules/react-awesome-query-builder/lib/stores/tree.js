...
var removeGroup = function removeGroup(state, path, config) {
  ...
  var isEmptyGroup = !(0, _treeUtils.hasChildren)(state, parentPath);
  ...
  if (isEmptyGroup && !canLeaveEmptyGroup) {
    ...
    if ((0, _treeUtils.isEmptyTree)(state)) {
...
var removeRule = function removeRule(state, path, config) {
  ...
  var isEmptyGroup = !(0, _treeUtils.hasChildren)(state, parentPath);
  var canLeaveEmpty = isEmptyGroup && (isParentRuleGroup ? hasGroupCountRule && parentFieldConfig.initialEmptyWhere : config.settings.canLeaveEmptyGroup);
