...
var formatRule = function formatRule(parents, item, config, meta) {
  ...
  var fvalue = iValue.map(function (currentValue, ind) {
    ...
    var _formatValue = formatValue(meta, config, cValue, valueSrc, valueType, fieldWidgetDef, fieldDef, realParentPath, operator, operatorDefinition),
...
var formatValue = function formatValue(meta, config, currentValue, valueSrc, valueType, fieldWidgetDef, fieldDef, parentPath, operator, operatorDef) {
  ...
  if (valueSrc == "field") {
    ...
    if (typeof fieldWidgetDef.mongoFormatValue === "function") {
      ...
      (0, _omit["default"])(fieldWidgetDef, ["formatValue", "mongoFormatValue", "sqlFormatValue", "jsonLogic"])];
...
var formatFunc = function formatFunc(meta, config, currentValue, parentPath) {
  ...
  for (var argKey in funcConfig.args) {
    ...
    var _formatValue3 = formatValue(meta, config, argValue, argValueSrc, argConfig.type, fieldWidgetDef, fieldDef, parentPath, argConfig, null, null),
