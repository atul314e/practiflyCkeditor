...
var formatGroup = function formatGroup(item, config, meta, isRoot) {
  ...
  if (isRuleGroup && mode != "struct") {
    if (isGroup0) {
      ...
      resultQuery = _defineProperty({}, op, [formatField(meta, config, field, parentField), resultQuery]);
    } else {
...
var formatItemValue = function formatItemValue(config, properties, meta, operator, parentField) {
  ...
  var fvalue = iValue.map(function (currentValue, ind) {
    ...
    var fv = formatValue(meta, config, cValue, valueSrc, valueType, fieldWidgetDef, fieldDefinition, operator, operatorDefinition, parentField);
