...
function List(_a) {
    var { children = React.createElement(ListItemField, { name: "$" }), className, error, errorMessage, info, initialCount, itemProps, label, labelCol, showInlineError, style = defaultStyle, value, wrapperCol } = _a, props = __rest(_a, ["children", "className", "error", "errorMessage", "info", "initialCount", "itemProps", "label", "labelCol", "showInlineError", "style", "value", "wrapperCol"]);
