...
function ListAdd(_a) {
    var { disabled, icon = React.createElement(PlusSquareOutlined, null), initialCount, name, readOnly, size = 'small', style = defaultStyle, type = 'dashed', value } = _a, props = __rest(_a, ["disabled", "icon", "initialCount", "name", "readOnly", "size", "style", "type", "value"]);
