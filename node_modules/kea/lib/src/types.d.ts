...
export declare type ReducerFunction<S = any> = (state: S, action: AnyAction, fullState: any) => S;
...
export declare type SelectorDefinition<Selectors, SelectorFunction extends any> = [(s: Selectors) => SelectorTuple, SelectorFunction] | [(s: Selectors) => SelectorTuple, SelectorFunction, any];
...
export declare type LogicInput<LogicType extends Logic = Logic> = {
    ...
    urlToAction?: (logic: LogicType) => Record<string, (params: Record<string, string | undefined>, searchParams: Record<string, any>, hashParams: Record<string, any>) => any>;
