...
function createReducerSelectors(logic, input) {
  ...
  Object.keys(logic.reducers).forEach(function (key) {
    logic.selectors[key] = reselect.createSelector(logic.selector, function (state) {
      return state[key];
    });
  });
}
...
function wrapComponent(Component, wrapper) {
  ...
  var isUnmounting = {};
  var lastState = {};
  var createConnect = reactRedux.connect(function (state, props) {
  ...
  var Kea = function Kea(props) {
    ...
    return /*#__PURE__*/React__namespace.createElement(Connect, props);
  };
