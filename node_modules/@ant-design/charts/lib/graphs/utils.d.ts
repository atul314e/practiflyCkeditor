...
export declare const bindSourceMapCollapseEvents: (graph: IGraph, fullData: FundFlowGraphConfig['data'] | FlowAnalysisGraphConfig['data'] | FlowGraphDatum | undefined) => void;
/**
